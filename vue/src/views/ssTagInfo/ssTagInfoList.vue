    ...
    <a-card :bordered="false">
      ...
      >
        ...
        <span slot="tagtype" slot-scope="text">
          <a-badge :status="text | tagTypeFilter" :text="text | typeFilter" />
        </span>
...
<script>
    ...
    import { getSsTagInfoList, saveSsTagInfo, delSsTagInfo, batchDelSsTagInfo } from '@/api/ssTagInfo'
    import EditForm from './ssTagInfoForm'
    import { tagTypeMap } from '@/api/goodsRelatedRC'
    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                loadData: parameter => {
                    ...
                    return getSsTagInfoList(requestParameters)
                        .then(res => {
                            return res.result
                        })
                },
        ...
        filters: {
            ...
            typeFilter (type) {
                return tagTypeMap[type].text
            },
            tagTypeFilter (type) {
                return tagTypeMap[type].status
            }
        },
        computed: {
            rowSelection () {
        ...
        methods: {
            ...
            handleBatchDel () {
                batchDelSsTagInfo(this.selectedRowKeys).then(res => {
                    this.confirmLoading = false
                    // 刷新表格
                    this.$refs.table.refresh()
