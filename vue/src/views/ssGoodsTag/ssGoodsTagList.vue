...
<script>
    ...
    import { getSsGoodsTagList, saveSsGoodsTag, delSsGoodsTag, batchDelSsGoodsTag } from '@/api/ssGoodsTag'
    import EditForm from './ssGoodsTagForm'
    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                loadData: parameter => {
                    ...
                    return getSsGoodsTagList(requestParameters)
                        .then(res => {
                            return res.result
                        })
                },
        ...
        methods: {
                ...
                form.validateFields((errors, values) => {
                    if (!errors) {
                        ...
                        if (values.id > 0) {
                            ...
                            saveSsGoodsTag(values).then(res => {
                                this.visible = false
            ...
            handleBatchDel () {
                batchDelSsGoodsTag(this.selectedRowKeys).then(res => {
                    this.confirmLoading = false
                    // 刷新表格
                    this.$refs.table.refresh()
