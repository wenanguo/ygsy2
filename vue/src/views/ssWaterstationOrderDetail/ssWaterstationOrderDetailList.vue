...
<script>
    ...
    import { getSsWaterstationOrderDetailList, saveSsWaterstationOrderDetail, delSsWaterstationOrderDetail, batchDelSsWaterstationOrderDetail } from '@/api/ssWaterstationOrderDetail'
    import EditForm from './ssWaterstationOrderDetailForm'
    ...
    const columns = [
        ...
        },       
        {
            title: '数量',
            sorter: true,
            dataIndex: 'ssOrderDetailNum'
        },        
        {
            title: '商品单价',
            sorter: true,
            dataIndex: 'ssOrderDetailPrice'
        },        
        // {
    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                loadData: parameter => {
                    ...
                    return getSsWaterstationOrderDetailList(requestParameters)
                        .then(res => {
                            return res.result
                        })
                },
        ...
        methods: {
                ...
                form.validateFields((errors, values) => {
                    if (!errors) {
                        ...
                        if (values.id > 0) {
                            ...
                            saveSsWaterstationOrderDetail(values).then(res => {
                                this.visible = false
            ...
            handleBatchDel () {
                batchDelSsWaterstationOrderDetail(this.selectedRowKeys).then(res => {
                    this.confirmLoading = false
                    // 刷新表格
                    this.$refs.table.refresh()
            ...
            handleDel (record) {
                if (record.id > 0) {
                    // 修改 e.g.
                    delSsWaterstationOrderDetail(record).then(res => {
                        this.confirmLoading = false
                        // 刷新表格
                        this.$refs.table.refresh()
