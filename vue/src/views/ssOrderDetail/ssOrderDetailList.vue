...
<script>
    ...
    import { getSsOrderDetailList, saveSsOrderDetail, delSsOrderDetail, batchDelSsOrderDetail } from '@/api/ssOrderDetail'
    import EditForm from './ssOrderDetailForm'
    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                loadData: parameter => {
                    ...
                    return getSsOrderDetailList(requestParameters)
                        .then(res => {
                            return res.result
                        })
                },
        ...
        methods: {
                ...
                form.validateFields((errors, values) => {
                    if (!errors) {
                        ...
                        if (values.id > 0) {
                            ...
                            saveSsOrderDetail(values).then(res => {
                                this.visible = false
            ...
            handleBatchDel () {
                batchDelSsOrderDetail(this.selectedRowKeys).then(res => {
                    this.confirmLoading = false
                    // 刷新表格
                    this.$refs.table.refresh()
            ...
            handleDel (record) {
                if (record.id > 0) {
                    // 修改 e.g.
                    delSsOrderDetail(record).then(res => {
                        this.confirmLoading = false
                        // 刷新表格
                        this.$refs.table.refresh()
