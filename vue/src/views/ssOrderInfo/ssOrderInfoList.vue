...
<script>
    ...
    import { getSsOrderInfoList, saveSsOrderInfo, delSsOrderInfo, batchDelSsOrderInfo } from '@/api/ssOrderInfo'
        ...
        data () {
            ...
            return {
                ...
                loadData: parameter => {
                    ...
                    console.log('loadData request parameters111:', requestParameters)
                   // 删除为空字符串属性
                    ...
                    return getSsOrderInfoList(requestParameters)
                        .then(res => {
                            return res.result
                        })
                },
