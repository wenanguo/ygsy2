        ...
        <a-spin :spinning="loading">
            <a-form :form="form" v-bind="formLayout">
                    ...
                    <a-form-item label="商品数量">
                        <a-input v-decorator="['goodsNum', {rules: [{required: true, min: 1, message: '请输入至少五个字符的规则描述！'}]}]" />
                    </a-form-item>
                    <a-form-item label="合计积分 本次购买的总积分">
                        <a-input v-decorator="['totalPoints', {rules: [{required: true, min: 1, message: '请输入至少五个字符的规则描述！'}]}]" />
                    </a-form-item>
            </a-form>
        </a-spin>
    </a-modal>
