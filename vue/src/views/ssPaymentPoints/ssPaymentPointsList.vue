...
<script>
    ...
    import { getSsPaymentPointsList, saveSsPaymentPoints, delSsPaymentPoints, batchDelSsPaymentPoints } from '@/api/ssPaymentPoints'
    import EditForm from './ssPaymentPointsForm'
    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                loadData: parameter => {
                    ...
                    return getSsPaymentPointsList(requestParameters)
                        .then(res => {
                            return res.result
                        })
                },
        ...
        methods: {
                ...
                form.validateFields((errors, values) => {
                    if (!errors) {
                        ...
                        if (values.id > 0) {
                            ...
                            saveSsPaymentPoints(values).then(res => {
                                this.visible = false
            ...
            handleBatchDel () {
                batchDelSsPaymentPoints(this.selectedRowKeys).then(res => {
                    this.confirmLoading = false
                    // 刷新表格
                    this.$refs.table.refresh()
            ...
            handleDel (record) {
                if (record.id > 0) {
                    // 修改 e.g.
                    delSsPaymentPoints(record).then(res => {
                        this.confirmLoading = false
                        // 刷新表格
                        this.$refs.table.refresh()
