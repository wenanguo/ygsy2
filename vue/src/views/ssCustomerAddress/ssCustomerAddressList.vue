          ...
          <a-row :gutter="48">
            <a-col :md="8" :sm="24">
              <a-form-item label="名称">
                <a-input v-model="queryParam.contacts" placeholder=""/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
...
<script>
    ...
    import { getSsCustomerAddressList, saveSsCustomerAddress, delSsCustomerAddress, batchDelSsCustomerAddress } from '@/api/ssCustomerAddress'
    import EditForm from './ssCustomerAddressForm'
    
   // var customerId1= this.$route.parmas.customerId
  //  const uid = this.$route.params,
    ...
    export default {
        ...
        data () {
            ...
            return {
               // uid:this.$route.params.customerId,
                // create model
                visible: false,
                title: '新增',
                ...
                loadData: parameter => {
                 //   console.log('uid=====:', this.$route.params.customerId);
                ...
                //    }
                    ...
                    return getSsCustomerAddressList(requestParameters)
                        .then(res => {
                            return res.result
                        })
                },
        ...
        methods: {
                ...
                form.validateFields((errors, values) => {
                    if (!errors) {
                        ...
                        if (values.id > 0) {
                            ...
                            saveSsCustomerAddress(values).then(res => {
                                this.visible = false
            ...
            handleBatchDel () {
                batchDelSsCustomerAddress(this.selectedRowKeys).then(res => {
                    this.confirmLoading = false
                    // 刷新表格
                    this.$refs.table.refresh()
            ...
            handleDel (record) {
                if (record.id > 0) {
                    // 修改 e.g.
                    delSsCustomerAddress(record).then(res => {
                        this.confirmLoading = false
                        // 刷新表格
                        this.$refs.table.refresh()
