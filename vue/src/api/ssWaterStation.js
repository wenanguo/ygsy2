...
const api = {
  ...
  waterStationDict: '/base/ss-water-station/stationDict',
  regionDict: '/base/ss-water-station/regionDict'
}
...
export function getWaterStationDict (parameter) {
  return request({
    url: api.waterStationDict,
    method: 'get',
    params: parameter
  })
}

export function getRegionDict (parameter) {
  return request({
    url: api.regionDict,
    method: 'get',
    params: parameter
