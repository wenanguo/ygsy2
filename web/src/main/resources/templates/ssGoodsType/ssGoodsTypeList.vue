...
<script>
    ...
    import { getSsGoodsTypeList, saveSsGoodsType, delSsGoodsType, batchDelSsGoodsType } from '@/api/ssGoodsType'
    import EditForm from './ssGoodsTypeForm'
    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                loadData: parameter => {
                    ...
                    return getSsGoodsTypeList(requestParameters)
                        .then(res => {
                            return res.result
                        })
                },
        ...
        methods: {
                ...
                form.validateFields((errors, values) => {
                    if (!errors) {
                        ...
                        if (values.id > 0) {
                            ...
                            saveSsGoodsType(values).then(res => {
                                this.visible = false
            ...
            handleBatchDel () {
                batchDelSsGoodsType(this.selectedRowKeys).then(res => {
                    this.confirmLoading = false
                    // 刷新表格
                    this.$refs.table.refresh()
            ...
            handleDel (record) {
                if (record.id > 0) {
                    // 修改 e.g.
                    delSsGoodsType(record).then(res => {
                        this.confirmLoading = false
                        // 刷新表格
                        this.$refs.table.refresh()
