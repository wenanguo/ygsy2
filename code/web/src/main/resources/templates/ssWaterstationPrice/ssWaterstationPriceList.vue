...
<script>
    ...
    import { getSsWaterstationPriceList, saveSsWaterstationPrice, delSsWaterstationPrice, batchDelSsWaterstationPrice } from '@/api/ssWaterstationPrice'
    import EditForm from './ssWaterstationPriceForm'
    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                loadData: parameter => {
                    ...
                    return getSsWaterstationPriceList(requestParameters)
                        .then(res => {
                            return res.result
                        })
                },
        ...
        methods: {
                ...
                form.validateFields((errors, values) => {
                    if (!errors) {
                        ...
                        if (values.id > 0) {
                            ...
                            saveSsWaterstationPrice(values).then(res => {
                                this.visible = false
            ...
            handleBatchDel () {
                batchDelSsWaterstationPrice(this.selectedRowKeys).then(res => {
                    this.confirmLoading = false
                    // 刷新表格
                    this.$refs.table.refresh()
            ...
            handleDel (record) {
                if (record.id > 0) {
                    // 修改 e.g.
                    delSsWaterstationPrice(record).then(res => {
                        this.confirmLoading = false
                        // 刷新表格
                        this.$refs.table.refresh()
