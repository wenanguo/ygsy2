...
@ApiModel(value="SsOrderInfo对象", description="订单信息")
public class SsOrderInfo extends BaseEntity implements Serializable {
    ...
    @ApiModelProperty(value = "订单状态，0-已取消，1-待分配，2-已接单，3-配送中，4-已完成")
    ...
    @TableField(exist = false)
    private List<SsOrderDetail> ssOrderDetails;
